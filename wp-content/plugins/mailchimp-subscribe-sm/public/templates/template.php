...
?>
  ...
  wp_enqueue_script('pluginops-optin-scripts-libs',  SMFB_PLUGIN_URL.'/public/scripts/scripts.js', array('jquery'), '1.0', true);

  $landingpageScriptsCounter = 0;
  foreach ($POPBallWidgetsScriptsFilesArray as $value) {

    wp_enqueue_script("pluginops-optin-script-files_$landingpageScriptsCounter", SMFB_PLUGIN_URL.$value , array('pluginops-optin-scripts-libs'), '1.0', true);
  ...
  foreach ($POPBallWidgetsStylesFilesArray as $value) {
    ...
    wp_enqueue_style( 'pluginops-optin-style-css-files_'.$landingpageScriptsCounter, SMFB_PLUGIN_URL.$value, array(), '1.0', $media = 'all' );
  ...
  wp_enqueue_script('pluginops-optin-scripts-inline-js-footer',  SMFB_PLUGIN_URL.'/public/scripts/scripts.js', array('jquery'), '1.0', true);


  $landingpageScriptsCounter = 0;
  foreach ($POPBallWidgetsScriptsArray as $value) {
    
    wp_add_inline_script('pluginops-optin-scripts-inline-js-footer', $value, 'after');

    $landingpageScriptsCounter++;

  }

  wp_add_inline_script('pluginops-optin-scripts-inline-js-footer', $pluginOpsCheckElViewFrameScript, 'after');


  wp_add_inline_script('pluginops-optin-scripts-inline-js-footer', $widgetAnimationTriggerScript, 'after');
