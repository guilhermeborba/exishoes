...
<option value="loja5_woo_cielo_webservice_pix"<?php echo ($tipo=='loja5_woo_cielo_webservice_pix')?' selected':'';?>>Pago por Pix</option>
</select>
</div>
...
<th scope="col" style="width:100px;">REF</th>
...
foreach($pedidos as $k => $v) {
	...
	<td>
	<b>Valor:</b> <?php echo $v->get_total();?><br>
	<b>Forma:</b> <?php echo isset($cielo['metodo'])?ucfirst($cielo['metodo']):''; ?> <?php echo isset($cielo['bandeira'])?ucfirst($cielo['bandeira']):''; ?> / <?php echo isset($cielo['total'])?'R$'.$cielo['total']:''; ?> <?php echo isset($cielo['parcela'])?' em '.$cielo['parcela'].'x':''; ?>
	<br><b>Por:</b> <?php echo $v->get_billing_first_name(); ?> <?php echo $v->get_billing_last_name(); ?>
	</td>
	...
	<td>
	<b><?php echo $this->status_cielo($status); ?></b>
	<br><i><?php echo isset($cielo['lr'])?$cielo['lr']:''; ?> <?php echo isset($cielo['lr_log'])?$cielo['lr_log']:''; ?></i>
	</td>
