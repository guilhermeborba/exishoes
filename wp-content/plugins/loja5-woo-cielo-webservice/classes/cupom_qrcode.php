...
if(isset($cielo['tid'])){
    ...
    if(isset($dados_pedido['Payment']['QrCodeBase64Image']) && !empty($dados_pedido['Payment']['QrCodeBase64Image'])){
		...
		<i>Abra o seu APP Cielo Pay (apenas <a href="https://play.google.com/store/apps/details?id=br.com.cielo.hyaku&hl=pt_BR&gl=US" target="_blank">android</a>) e aponte o leitor de QrCode para esta imagem e conclua o pagamento diretamente de seu APP, ao pagar aguarde alguns segundos que a tela ser&aacute; automaticamente atualizada.</i><br>';
	}
    $html .='<br>
