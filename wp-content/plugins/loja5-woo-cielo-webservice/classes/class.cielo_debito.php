<?php
    class WC_Gateway_Loja5_Woo_Cielo_Webservice_Debito extends WC_Payment_Gateway {
        ...
        public function __construct() {
            ...
            $this->method_title = 'Cielo API - Débito';
            $this->init_settings();
        ...
        public function init_form_fields() {
			...
			if(file_exists(CIELO_WEBSERVICE_WOO_PATH.'/include/licenciamento.php')){
				...
				$this->form_fields = gateway_woo_cielo_webservice_loja5_licensa_debito($this);
			}else{
        ...
        public function process_payment($order_id) {
			...
			if($response->status==401){
				...
				if(isset($dados_pedido['Code'])){
					...
					if(!empty($this->get_post('auth')) && $this->settings['3ds']=='yes' && ($bandeira=='Visa' || $bandeira=='Master' || $bandeira=='Elo')){
