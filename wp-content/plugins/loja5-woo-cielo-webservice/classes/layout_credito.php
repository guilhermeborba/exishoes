...
<input style="box-shadow: inset 2px 0 0 #0f834d;height:40px;background-color: #f2f2f2;" type="text" class="input-text nome_titular_cielo_webservice" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" placeholder="Nome como impresso no cart&atilde;o" name="cielo_webservice[titular]" value="">
</p>

<?php if(strlen($fiscal)==11 || strlen($fiscal)==14 || $anti_fraude==false || $currency_code!='BRL' || (isset($output['billing_country']) && $output['billing_country']!='BR')){ ?>
...
<input style="box-shadow: inset 2px 0 0 #0f834d;height:40px;background-color: #f2f2f2;" onkeyup="this.value=this.value.replace(/[^\d]/,'')" maxlength="19" onblur="detectar_bandeira_cartao_credito_cielo_loja5(this.value)" type="text" class="input-text mascaras_cartao_cielo_webservice" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" placeholder="0000000000000000" name="cielo_webservice[numero]" value="">
</p>
