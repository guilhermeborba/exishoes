...
<input type="hidden" name="cielo_webservice_qrcode[hash_total_cielo]" value="<?php echo sha1(number_format($total_cart, 2, '.', ''));?>">
<input type="hidden" name="cielo_webservice_qrcode[total_cielo]" value="<?php echo number_format($total_cart, 2, '.', '');?>">
