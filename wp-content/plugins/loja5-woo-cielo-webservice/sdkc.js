function bpmpi_authenticate_credito() { 
    BP.Mpi.authenticate() 
} 
function bpmpi_load() { 
    BP.Mpi.load() 
...
var BP = function () { 
    function e(e) { return document.getElementsByClassName(e).length > 0 } 
    function r(r) { return e(r) ? document.getElementsByClassName(r)[0].value : null } 
    function n(r, n) { return e(r) ? document.getElementsByClassName(r)[0].value : n } 
    function i(e) { return e.replace("bpmpi_", "").replace(/\_/g, "") } 
    function t(e) { return /\#/.test(e) } 
    function o(e, r) { return e.replace(/\#/, r) } 
    function a(e) { 
        var r = i(e), n = r.split("#"); 
        return { enumerable: n[0], field: n[1] } } 
        function s() { var n = {}; 
        for (var s in N) { 
            var p = N[s]; 
            if (t(p) === !1) { var c = i(p), u = r(p); u && (n[c] = r(p)) } 
            else 
                for (var d = 1, l = o(p, d); e(l);) { 
                    var m = a(p); n[m.enumerable] || (n[m.enumerable] = []), u = r(l), n[m.enumerable][d - 1] || (n[m.enumerable][d - 1] = {}), n[m.enumerable][d - 1][m.field] = u, d++, l = o(p, d) 
                } 
        } 
        return n 
    } 
    function p() { return "undefined" != typeof bpmpi_config_credito ? bpmpi_config_credito() : { Debug: !0, Environment: "PRD" } } 
    function c() { return D.Environment || "PRD" } 
    function u() { var e = c(), r = { 
    ...
    function d() { 
        return { orderNumber: r("bpmpi_ordernumber"), currency: r("bpmpi_currency"), amount: r("bpmpi_totalamount") } 
    } 
    function l(e) { var r = c(), n = { 
        TST: "https://localhost:44351", 
        SDB: "https://mpisandbox.braspag.com.br", 
        PRD: "https://mpi.braspag.com.br" 
    }; 
    return n[r] + e } function m(e, r) { var n = document.getElementsByTagName("head")[0], i = document.createElement("script"); i.type = "text/javascript", i.src = e, i.onreadystatechange = r, i.onload = r, n.appendChild(i) } 
    
    function _() { return "undefined" !== D.Debug ? D.Debug : !1 } 
    function b() { _() && console.log.apply(null, arguments) } 
    function h() { return _() ? "verbose" : "off" } 
    function g(e, r) { 
        T = r, b("[MPI]", "Initializing..."), 
        b("[MPI]", "Token =", e), 
        b("[MPI]", "ReferenceId =", T), 
        Cardinal.configure({ timeout: "8000", 
        maxRequestRetries: "10", 
        logging: { level: h() } }), 
        Cardinal.setup("init", { jwt: e }), 
        Cardinal.on("payments.setupComplete", 
        function (e) { 
            b("[MPI]", "Setup complete."),
            b("[MPI]", "SetupCompleteData =", e), M("onReady") 
        }), 
        Cardinal.on("payments.validated", function (e) { 
            switch (b("[MPI]", "Payment validated."), b("[MPI]", "ActionCode =", e.ActionCode), b("[MPI]", "Data =", e), e.ActionCode) { 
                ...
                case "FAILURE": 
                    ...
                    break; 
                case "ERROR": 
                    k.Number = e.ErrorNumber, k.Description = e.ErrorDescription, e.Payment && e.Payment.ProcessorTransactionId ? A(e.Payment.ProcessorTransactionId) : M("onError", { Xid: null, Eci: null, ReturnCode: k.HasError() ? k.Number : "MPI901", ReturnMessage: k.HasError() ? k.Description : "Unexpected error", ReferenceId: null }); 
                    break; 
                default: k.Number = e.ErrorNumber, k.Description = e.ErrorDescription, "Success" === e.ErrorDescription && e.Payment && e.Payment.ProcessorTransactionId ? A(e.Payment.ProcessorTransactionId) : M("onError", { Xid: null, Eci: null, ReturnCode: k.HasError() ? k.Number : "MPI902", ReturnMessage: k.HasError() ? k.Description : "Unexpected authentication response", ReferenceId: null }) 
            } 
        }) 
    } 
    
    function f(e, n, i) { var t = JSON.stringify(n), o = new XMLHttpRequest; o.onreadystatechange = function () { if (4 === this.readyState) if (200 === this.status) { var e = JSON.parse(o.responseText); i(e, this) } else M("onError", { Xid: null, Eci: null, ReturnCode: "MPI900", ReturnMessage: "An error has occurred (" + this.status + ")", ReferenceId: null }) }, o.open("POST", l(e)), o.setRequestHeader("Content-Type", "application/json"), o.setRequestHeader("Authorization", "Bearer " + r("bpmpi_accesstoken")), o.send(t) } 
    function C() { var e = n("bpmpi_auth", "true"); return b("[MPI]", "Authentication Enabled =", e), "false" === e ? (M("onDisabled"), !1) : !0 } 
    function E() { 
        if (b("[MPI]", "Debug =", _()), b("[MPI]", "Enviroment =", c()), C()) { if (O) return void b("[MPI]", "Resources already loaded..."); b("[MPI]", "Loading resources..."), O = !0, m(u(), function () { b("[MPI]", "Cardinal script loaded."), f("/v2/3ds/init", d(), function (e) { g(e.Token, e.ReferenceId) }) }) } } 
    function I() { if (C()) { if (!O) return void b("[MPI]", "Resources not loaded..."); b("[MPI]", "Enrolling..."), Cardinal.trigger("accountNumber.update", r("bpmpi_cardnumber")), f("/v2/3ds/enroll", s(), function (e) { b("[MPI]", "Enrollment result =", e), e.Version && (X = e.Version[0]); var r = e.Authentication; switch (e.Status) { case "ENROLLED": R(e); break; case "VALIDATION_NEEDED": A(e.AuthenticationTransactionId); break; case "AUTHENTICATION_CHECK_NEEDED": v(r); break; case "NOT_ENROLLED": M("onUnenrolled", { Xid: r.Xid, Eci: r.Eci, Version: X, ReferenceId: r.DirectoryServerTransactionId }); break; case "FAILED": M("onFailure", { Xid: r.Xid, Eci: r.Eci || r.EciRaw, Version: X, ReferenceId: r.DirectoryServerTransactionId }); break; case "UNSUPPORTED_BRAND": M("onUnsupportedBrand", { Xid: null, Eci: null, ReturnCode: e.ReturnCode, ReturnMessage: e.ReturnMessage, ReferenceId: null }); break; default: M("onError", { Xid: null, Eci: null, ReturnCode: e.ReturnCode, ReturnMessage: e.ReturnMessage, ReferenceId: null }) } }) } } 
    
    function y(e, r) { return e[r] || null } 
    ...
    function P(e) { 
        ...
        n = { 
            ...
            Consumer: 
            { 
                Account: { AccountNumber: r.cardnumber.replace(/\s/g, ""), ExpirationMonth: r.cardexpirationmonth, ExpirationYear: r.cardexpirationyear }, Email1: y(r, "shiptoemail"), Email2: y(r, "billtoemail"), ShippingAddress: { FullName: null, Address1: null, Address2: null, City: null, State: null, PostalCode: null, CountryCode: null, Phone1: null }, BillingAddress: { FullName: y(r, "billtocontactname"), Address1: y(r, "billtostreet1"), Address2: y(r, "billtostreet2"), City: y(r, "billtocity"), State: null === y(r, "billtostate") ? null : y(r, "billtostate").toUpperCase(), PostalCode: y(r, "billtozipcode"), CountryCode: y(r, "billtocountry"), Phone1: y(r, "billtophonenumber") } 
            }, 
            Cart: [] 
            ...
            n.Consumer.ShippingAddress.FullName = y(r, "shiptoaddressee"), n.Consumer.ShippingAddress.Address1 = y(r, "shiptostreet1"), 
            n.Consumer.ShippingAddress.Address2 = y(r, "shiptostreet2"), 
            n.Consumer.ShippingAddress.City = y(r, "shiptocity"), 
            n.Consumer.ShippingAddress.State = null === y(r, "shiptostate") ? null : y(r, "shiptostate").toUpperCase(), 
            n.Consumer.ShippingAddress.PostalCode = y(r, "shiptozipcode"), 
            n.Consumer.ShippingAddress.Phone1 = y(r, "shiptophonenumber"), 
            n.Consumer.ShippingAddress.CountryCode = y(r, "shiptocountry"); 
            if (r.cart) 
                for (var t in r.cart) 
                    n.Cart.push({ 
    ...
    function R(e) { 
        ...
        if (b("[MPI] Suppression enabled = " + n), "true" === n) 
            return b("[MPI]", "Challenge supressed..."), 
            ...
            b("[MPI] Continue object =", i), 
            Cardinal.continue("cca", i, t) 
    } 
    function v(e) { 
        switch (b("[MPI]", "Authentication result =", e), e.Status) { 
            case "AUTHENTICATED": M("onSuccess", { Cavv: e.Cavv, Xid: e.Xid, Eci: e.Eci, Version: e.Version[0], ReferenceId: e.DirectoryServerTransactionId }); break; case "UNAVAILABLE": M("onUnenrolled", { Xid: e.Xid, Eci: e.Eci, Version: e.Version[0], ReferenceId: e.DirectoryServerTransactionId }); break; 
            case "FAILED": M("onFailure", { Xid: e.Xid, Eci: e.Eci || e.EciRaw, Version: e.Version[0], ReferenceId: e.DirectoryServerTransactionId }); break; 
            case "ERROR_OCCURRED": 
                M("onError", { Xid: e.Xid, Eci: e.Eci || e.EciRaw, ReturnCode: e.ReturnCode, ReturnMessage: e.ReturnMessage, ReferenceId: e.DirectoryServerTransactionId }); 
                break; 
            default: 
                M("onError", { 
                    Xid: e.Xid, 
    ...
    O = !1; 
    return { 
        Mpi: { load: function () { E() }, authenticate: function () { I() } } 
    }
}(); 
bpmpi_load();